...
const wowAndaman: PackageReview = {
  slug: "wow-andaman",
  ...
  inclusions: [
    ...
    "All entry and ferry tickets wherever applicable",
  ...
  exclusions: [
    ...
    "Optional meals, activities, or water sports",
  ...
  terms: [
    ...
    "Package quotes are tentative and may change based on real-time availability.",
    "Payments must follow the defined payment policy.",
    "All cancellations must be submitted in writing; cancellation charges apply.",
    "Go Escapio reserves the right to modify itineraries due to unforeseen circumstances.",
    "Travellers are responsible for valid travel documents.",
    "Go Escapio is not responsible for flight delays, baggage issues, or cancellations.",
    "Hotel check-in is generally at 2 PM and check-out at 11 AM.",
    "City taxes, personal expenses, and optional tours are not included.",
