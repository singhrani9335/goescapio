...
export default function DestinationMegaMenu({
  ...
  const [activeRegion, setActiveRegion] =
    useState<DestinationRegion | null>(null);
  ...
  return (
    <div
      className="absolute left-1/2 top-full z-50 mt-0 w-[1120px] -translate-x-1/2 overflow-hidden  border border-gray-200 bg-white shadow-[0_25px_70px_rgba(0,0,0,0.15)]"
      onMouseLeave={() => {
        setActiveRegion(null);
        setActiveDestination(null);
      }}
    >
      ...
      <div className="border-b border-gray-200 px-8 py-4">
        <h2 className="text-lg font-semibold uppercase tracking-[2px] text-gray-900">
          Destinations
        </h2>
      </div>
        ...
        {!activeRegion && (
          <div className="flex-1 p-6">
            <div className="relative h-full w-full overflow-hidden rounded-2xl">
              <Image
                src="/images/destinations/default-banner.jpg"
                alt="Destinations"
                fill
                priority
